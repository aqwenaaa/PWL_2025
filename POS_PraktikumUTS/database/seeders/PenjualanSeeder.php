...
class PenjualanSeeder extends Seeder
{
    ...
    {
        $data = [
            ['user_id' => 1, 'pembeli' => 'Aldo', 'penjualan_kode' => 'TRX0001', 'penjualan_tanggal' => Carbon::now()->subDays(2)],
            ...
            ['user_id' => 1, 'pembeli' => 'Aqueena', 'penjualan_kode' => 'TRX0007', 'penjualan_tanggal' => Carbon::now()->subDays(7)],
